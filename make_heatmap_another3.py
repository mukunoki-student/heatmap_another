...
# 入力フォルダのパス
csv_base_path = Path("C:/Users/mukunoki/Desktop/heatmap_another/psychopy_data_csv/202110011-001_csv")
...
# CSVファイルごとに処理
for csv_file in csv_base_path.glob("*.csv"):
    # CSVファイルの読み込み
    ...
    output_file_path = output_base_path / f"{csv_file.stem}_heatmap.png"
